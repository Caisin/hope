...
func (x *PageConfigPageReply) GetCode() int64 {
	if x != nil {
		return x.Code
	}
	return 0
...
func (x *PageConfigReply) GetCode() int64 {
	if x != nil {
		return x.Code
	}
	return 0
...
func (x *PageConfigCreateReply) GetCode() int64 {
	if x != nil {
		return x.Code
	}
	return 0
...
func (x *PageConfigUpdateReply) GetCode() int64 {
	if x != nil {
		return x.Code
	}
	return 0
...
func (x *PageConfigDeleteReply) GetCode() int64 {
	if x != nil {
		return x.Code
	}
	return 0
...
var file_api_param_pageconfig_v1_page_config_proto_rawDesc = []byte{
	...
	0x50, 0x61, 0x67, 0x65, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x12, 0x20, 0x2e, 0x70, 0x61, 0x67,
...
var file_api_param_pageconfig_v1_page_config_proto_depIdxs = []int32{
	...
	1,  // 10: pageconfig.v1.PageConfig.GetPagePageConfig:input_type -> pageconfig.v1.PageConfigPageReq
	...
	2,  // 16: pageconfig.v1.PageConfig.GetPagePageConfig:output_type -> pageconfig.v1.PageConfigPageReply
