...
func (avc *AppVersionCreate) check() error {
	if _, ok := avc.mutation.CreatedAt(); !ok {
		return &ValidationError{Name: "createdAt", err: errors.New(`ent: missing required field "AppVersion.createdAt"`)}
	}
	if _, ok := avc.mutation.UpdatedAt(); !ok {
		return &ValidationError{Name: "updatedAt", err: errors.New(`ent: missing required field "AppVersion.updatedAt"`)}
	}
	if _, ok := avc.mutation.CreateBy(); !ok {
		return &ValidationError{Name: "createBy", err: errors.New(`ent: missing required field "AppVersion.createBy"`)}
	}
	if _, ok := avc.mutation.UpdateBy(); !ok {
		return &ValidationError{Name: "updateBy", err: errors.New(`ent: missing required field "AppVersion.updateBy"`)}
	}
	if _, ok := avc.mutation.TenantId(); !ok {
		return &ValidationError{Name: "tenantId", err: errors.New(`ent: missing required field "AppVersion.tenantId"`)}
	}
	return nil
}
