...
func columnChecker(table string) func(string) error {
	checks := map[string]func(string) bool{
		...
		activitycomponent.Table:     activitycomponent.ValidColumn,
		adchangelog.Table:           adchangelog.ValidColumn,
		adchannel.Table:             adchannel.ValidColumn,
		agreementlog.Table:          agreementlog.ValidColumn,
		ambalance.Table:             ambalance.ValidColumn,
		appversion.Table:            appversion.ValidColumn,
		assetchangelog.Table:        assetchangelog.ValidColumn,
		assetitem.Table:             assetitem.ValidColumn,
		bookpackage.Table:           bookpackage.ValidColumn,
		clienterror.Table:           clienterror.ValidColumn,
		customernovelconfig.Table:   customernovelconfig.ValidColumn,
		customernovels.Table:        customernovels.ValidColumn,
		datasource.Table:            datasource.ValidColumn,
		listenrecord.Table:          listenrecord.ValidColumn,
		novel.Table:                 novel.ValidColumn,
		novelautobuy.Table:          novelautobuy.ValidColumn,
		novelbookshelf.Table:        novelbookshelf.ValidColumn,
		novelbuychapterrecord.Table: novelbuychapterrecord.ValidColumn,
		novelbuyrecord.Table:        novelbuyrecord.ValidColumn,
		novelchapter.Table:          novelchapter.ValidColumn,
		novelclassify.Table:         novelclassify.ValidColumn,
		novelcomment.Table:          novelcomment.ValidColumn,
		novelconsume.Table:          novelconsume.ValidColumn,
		novelmsg.Table:              novelmsg.ValidColumn,
		payorder.Table:              payorder.ValidColumn,
		socialuser.Table:            socialuser.ValidColumn,
		tasklog.Table:               tasklog.ValidColumn,
		userevent.Table:             userevent.ValidColumn,
		usermsg.Table:               usermsg.ValidColumn,
		vipuser.Table:               vipuser.ValidColumn,
	}
