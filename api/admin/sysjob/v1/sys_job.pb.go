...
func (x *SysJobPageReply) GetCode() int64 {
	if x != nil {
		return x.Code
	}
	return 0
...
func (x *SysJobReply) GetCode() int64 {
	if x != nil {
		return x.Code
	}
	return 0
...
func (x *SysJobCreateReply) GetCode() int64 {
	if x != nil {
		return x.Code
	}
	return 0
...
func (x *SysJobUpdateReply) GetCode() int64 {
	if x != nil {
		return x.Code
	}
	return 0
...
func (x *SysJobDeleteReply) GetCode() int64 {
	if x != nil {
		return x.Code
	}
	return 0
...
var file_api_admin_sysjob_v1_sys_job_proto_rawDesc = []byte{
	...
	0x5f, 0x0a, 0x0d, 0x47, 0x65, 0x74, 0x50, 0x61, 0x67, 0x65, 0x53, 0x79, 0x73, 0x4a, 0x6f, 0x62,
...
var file_api_admin_sysjob_v1_sys_job_proto_depIdxs = []int32{
	...
	1,  // 10: sysjob.v1.SysJob.GetPageSysJob:input_type -> sysjob.v1.SysJobPageReq
	...
	2,  // 16: sysjob.v1.SysJob.GetPageSysJob:output_type -> sysjob.v1.SysJobPageReply
