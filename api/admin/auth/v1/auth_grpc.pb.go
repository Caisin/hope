...
func (c *authClient) Login(ctx context.Context, in *LoginReq, opts ...grpc.CallOption) (*LoginReply, error) {
	out := new(LoginReply)
	err := c.cc.Invoke(ctx, "/sysuser.v1.Auth/Login", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *authClient) LogOut(ctx context.Context, in *LogOutReq, opts ...grpc.CallOption) (*LogOutReply, error) {
	out := new(LogOutReply)
	err := c.cc.Invoke(ctx, "/sysuser.v1.Auth/LogOut", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Auth_Login_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/sysuser.v1.Auth/Login",
	}
...
func _Auth_LogOut_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/sysuser.v1.Auth/LogOut",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var Auth_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "api/admin/auth/v1/auth.proto",
}
