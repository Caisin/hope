...
func (uasc *UserAnalysisStatisticsCreate) check() error {
	if _, ok := uasc.mutation.StatisticsDate(); !ok {
		return &ValidationError{Name: "statisticsDate", err: errors.New(`ent: missing required field "UserAnalysisStatistics.statisticsDate"`)}
	}
	if _, ok := uasc.mutation.CreatedAt(); !ok {
		return &ValidationError{Name: "createdAt", err: errors.New(`ent: missing required field "UserAnalysisStatistics.createdAt"`)}
	}
	if _, ok := uasc.mutation.UpdatedAt(); !ok {
		return &ValidationError{Name: "updatedAt", err: errors.New(`ent: missing required field "UserAnalysisStatistics.updatedAt"`)}
	}
	if _, ok := uasc.mutation.CreateBy(); !ok {
		return &ValidationError{Name: "createBy", err: errors.New(`ent: missing required field "UserAnalysisStatistics.createBy"`)}
	}
	if _, ok := uasc.mutation.UpdateBy(); !ok {
		return &ValidationError{Name: "updateBy", err: errors.New(`ent: missing required field "UserAnalysisStatistics.updateBy"`)}
	}
	if _, ok := uasc.mutation.TenantId(); !ok {
		return &ValidationError{Name: "tenantId", err: errors.New(`ent: missing required field "UserAnalysisStatistics.tenantId"`)}
	}
	return nil
}
