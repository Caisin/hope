...
func (x *ScoreProductPageReply) GetCode() int64 {
	if x != nil {
		return x.Code
	}
	return 0
...
func (x *ScoreProductReply) GetCode() int64 {
	if x != nil {
		return x.Code
	}
	return 0
...
func (x *ScoreProductCreateReply) GetCode() int64 {
	if x != nil {
		return x.Code
	}
	return 0
...
func (x *ScoreProductUpdateReply) GetCode() int64 {
	if x != nil {
		return x.Code
	}
	return 0
...
func (x *ScoreProductDeleteReply) GetCode() int64 {
	if x != nil {
		return x.Code
	}
	return 0
...
var file_api_param_scoreproduct_v1_score_product_proto_depIdxs = []int32{
	...
	1,  // 18: scoreproduct.v1.ScoreProduct.GetPageScoreProduct:input_type -> scoreproduct.v1.ScoreProductPageReq
	...
	2,  // 24: scoreproduct.v1.ScoreProduct.GetPageScoreProduct:output_type -> scoreproduct.v1.ScoreProductPageReply
