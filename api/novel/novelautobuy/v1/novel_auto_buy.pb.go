...
func (x *NovelAutoBuyPageReply) GetCode() int32 {
	if x != nil {
		return x.Code
	}
	return 0
...
func (x *NovelAutoBuyReply) GetCode() int32 {
	if x != nil {
		return x.Code
	}
	return 0
...
func (x *NovelAutoBuyCreateReply) GetCode() int32 {
	if x != nil {
		return x.Code
	}
	return 0
...
func (x *NovelAutoBuyUpdateReply) GetCode() int32 {
	if x != nil {
		return x.Code
	}
	return 0
...
func (x *NovelAutoBuyDeleteReply) GetCode() int32 {
	if x != nil {
		return x.Code
	}
	return 0
...
var file_api_novel_novelautobuy_v1_novel_auto_buy_proto_rawDesc = []byte{
	...
	0x6f, 0x42, 0x75, 0x79, 0x12, 0x84, 0x01, 0x0a, 0x13, 0x47, 0x65, 0x74, 0x4e, 0x6f, 0x76, 0x65,
	0x6c, 0x41, 0x75, 0x74, 0x6f, 0x42, 0x75, 0x79, 0x50, 0x61, 0x67, 0x65, 0x12, 0x24, 0x2e, 0x6e,
...
var file_api_novel_novelautobuy_v1_novel_auto_buy_proto_depIdxs = []int32{
	...
	1,  // 10: novelautobuy.v1.NovelAutoBuy.GetNovelAutoBuyPage:input_type -> novelautobuy.v1.NovelAutoBuyPageReq
	...
	2,  // 16: novelautobuy.v1.NovelAutoBuy.GetNovelAutoBuyPage:output_type -> novelautobuy.v1.NovelAutoBuyPageReply
