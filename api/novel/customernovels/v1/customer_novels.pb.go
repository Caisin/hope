...
func (x *CustomerNovelsPageReply) GetCode() int64 {
	if x != nil {
		return x.Code
	}
	return 0
...
func (x *CustomerNovelsReply) GetCode() int64 {
	if x != nil {
		return x.Code
	}
	return 0
...
func (x *CustomerNovelsCreateReply) GetCode() int64 {
	if x != nil {
		return x.Code
	}
	return 0
...
func (x *CustomerNovelsUpdateReply) GetCode() int64 {
	if x != nil {
		return x.Code
	}
	return 0
...
func (x *CustomerNovelsDeleteReply) GetCode() int64 {
	if x != nil {
		return x.Code
	}
	return 0
...
var file_api_novel_customernovels_v1_customer_novels_proto_rawDesc = []byte{
	...
	0x65, 0x74, 0x50, 0x61, 0x67, 0x65, 0x43, 0x75, 0x73, 0x74, 0x6f, 0x6d, 0x65, 0x72, 0x4e, 0x6f,
	0x76, 0x65, 0x6c, 0x73, 0x12, 0x28, 0x2e, 0x63, 0x75, 0x73, 0x74, 0x6f, 0x6d, 0x65, 0x72, 0x6e,
...
var file_api_novel_customernovels_v1_customer_novels_proto_depIdxs = []int32{
	...
	1,  // 18: customernovels.v1.CustomerNovels.GetPageCustomerNovels:input_type -> customernovels.v1.CustomerNovelsPageReq
	...
	2,  // 24: customernovels.v1.CustomerNovels.GetPageCustomerNovels:output_type -> customernovels.v1.CustomerNovelsPageReply
