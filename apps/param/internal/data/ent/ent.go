...
func columnChecker(table string) func(string) error {
	checks := map[string]func(string) bool{
		novelpayconfig.Table:         novelpayconfig.ValidColumn,
		noveltag.Table:               noveltag.ValidColumn,
		pageconfig.Table:             pageconfig.ValidColumn,
		qiniuconfig.Table:            qiniuconfig.ValidColumn,
		resourcegroup.Table:          resourcegroup.ValidColumn,
		resourcestorage.Table:        resourcestorage.ValidColumn,
		scoreproduct.Table:           scoreproduct.ValidColumn,
		task.Table:                   task.ValidColumn,
		useranalysisstatistics.Table: useranalysisstatistics.ValidColumn,
		userconsume.Table:            userconsume.ValidColumn,
		userresource.Table:           userresource.ValidColumn,
		userresourcerecord.Table:     userresourcerecord.ValidColumn,
		viptype.Table:                viptype.ValidColumn,
	}
