...
func (vuc *VipUserCreate) check() error {
	if _, ok := vuc.mutation.UserId(); !ok {
		return &ValidationError{Name: "userId", err: errors.New(`ent: missing required field "VipUser.userId"`)}
	}
	if _, ok := vuc.mutation.EffectTime(); !ok {
		return &ValidationError{Name: "effectTime", err: errors.New(`ent: missing required field "VipUser.effectTime"`)}
	}
	if _, ok := vuc.mutation.ExpiredTime(); !ok {
		return &ValidationError{Name: "expiredTime", err: errors.New(`ent: missing required field "VipUser.expiredTime"`)}
	}
	if _, ok := vuc.mutation.CreatedAt(); !ok {
		return &ValidationError{Name: "createdAt", err: errors.New(`ent: missing required field "VipUser.createdAt"`)}
	}
	if _, ok := vuc.mutation.UpdatedAt(); !ok {
		return &ValidationError{Name: "updatedAt", err: errors.New(`ent: missing required field "VipUser.updatedAt"`)}
	}
	if _, ok := vuc.mutation.CreateBy(); !ok {
		return &ValidationError{Name: "createBy", err: errors.New(`ent: missing required field "VipUser.createBy"`)}
	}
	if _, ok := vuc.mutation.UpdateBy(); !ok {
		return &ValidationError{Name: "updateBy", err: errors.New(`ent: missing required field "VipUser.updateBy"`)}
	}
	if _, ok := vuc.mutation.TenantId(); !ok {
		return &ValidationError{Name: "tenantId", err: errors.New(`ent: missing required field "VipUser.tenantId"`)}
	}
	if _, ok := vuc.mutation.UserID(); !ok {
		return &ValidationError{Name: "user", err: errors.New(`ent: missing required edge "VipUser.user"`)}
	}
	return nil
}
