...
func (x *SysRolePageReply) GetCode() int64 {
	if x != nil {
		return x.Code
	}
	return 0
...
func (x *SysRoleReply) GetCode() int64 {
	if x != nil {
		return x.Code
	}
	return 0
...
func (x *SysRoleCreateReply) GetCode() int64 {
	if x != nil {
		return x.Code
	}
	return 0
...
func (x *SysRoleUpdateReply) GetCode() int64 {
	if x != nil {
		return x.Code
	}
	return 0
...
func (x *SysRoleDeleteReply) GetCode() int64 {
	if x != nil {
		return x.Code
	}
	return 0
...
var file_api_admin_sysrole_v1_sys_role_proto_rawDesc = []byte{
	...
	0x65, 0x12, 0x65, 0x0a, 0x0e, 0x47, 0x65, 0x74, 0x50, 0x61, 0x67, 0x65, 0x53, 0x79, 0x73, 0x52,
	0x6f, 0x6c, 0x65, 0x12, 0x1a, 0x2e, 0x73, 0x79, 0x73, 0x72, 0x6f, 0x6c, 0x65, 0x2e, 0x76, 0x31,
...
var file_api_admin_sysrole_v1_sys_role_proto_depIdxs = []int32{
	...
	1,  // 10: sysrole.v1.SysRole.GetPageSysRole:input_type -> sysrole.v1.SysRolePageReq
	...
	2,  // 16: sysrole.v1.SysRole.GetPageSysRole:output_type -> sysrole.v1.SysRolePageReply
