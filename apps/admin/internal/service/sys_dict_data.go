...
func (s *SysDictDataService) GetSysDictDataPage(ctx context.Context, req *pb.SysDictDataPageReq) (*pb.SysDictDataPageReply, error) {
	tr := otel.Tracer("api")
	ctx, span := tr.Start(ctx, "GetSysDictDataPage")
	defer span.End()
