...
func (x *VipUserPageReply) GetCode() int32 {
	if x != nil {
		return x.Code
	}
	return 0
...
func (x *VipUserReply) GetCode() int32 {
	if x != nil {
		return x.Code
	}
	return 0
...
func (x *VipUserCreateReply) GetCode() int32 {
	if x != nil {
		return x.Code
	}
	return 0
...
func (x *VipUserUpdateReply) GetCode() int32 {
	if x != nil {
		return x.Code
	}
	return 0
...
func (x *VipUserDeleteReply) GetCode() int32 {
	if x != nil {
		return x.Code
	}
	return 0
...
var file_api_novel_vipuser_v1_vip_user_proto_rawDesc = []byte{
	...
	0x72, 0x12, 0x65, 0x0a, 0x0e, 0x47, 0x65, 0x74, 0x56, 0x69, 0x70, 0x55, 0x73, 0x65, 0x72, 0x50,
	0x61, 0x67, 0x65, 0x12, 0x1a, 0x2e, 0x76, 0x69, 0x70, 0x75, 0x73, 0x65, 0x72, 0x2e, 0x76, 0x31,
...
var file_api_novel_vipuser_v1_vip_user_proto_depIdxs = []int32{
	...
	1,  // 26: vipuser.v1.VipUser.GetVipUserPage:input_type -> vipuser.v1.VipUserPageReq
	...
	2,  // 32: vipuser.v1.VipUser.GetVipUserPage:output_type -> vipuser.v1.VipUserPageReply
