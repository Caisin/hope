...
func (crq *CasbinRuleQuery) FirstID(ctx context.Context) (id int64, err error) {
	var ids []int64
...
func (crq *CasbinRuleQuery) FirstIDX(ctx context.Context) int64 {
...
func (crq *CasbinRuleQuery) OnlyID(ctx context.Context) (id int64, err error) {
	var ids []int64
...
func (crq *CasbinRuleQuery) OnlyIDX(ctx context.Context) int64 {
...
func (crq *CasbinRuleQuery) IDs(ctx context.Context) ([]int64, error) {
	var ids []int64
...
func (crq *CasbinRuleQuery) IDsX(ctx context.Context) []int64 {
	ids, err := crq.IDs(ctx)
	if err != nil {
		panic(err)
	}
