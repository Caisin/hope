...
func (x *ActivityPageReply) GetCode() int64 {
	if x != nil {
		return x.Code
	}
	return 0
...
func (x *ActivityReply) GetCode() int64 {
	if x != nil {
		return x.Code
	}
	return 0
...
func (x *ActivityCreateReply) GetCode() int64 {
	if x != nil {
		return x.Code
	}
	return 0
...
func (x *ActivityUpdateReply) GetCode() int64 {
	if x != nil {
		return x.Code
	}
	return 0
...
func (x *ActivityDeleteReply) GetCode() int64 {
	if x != nil {
		return x.Code
	}
	return 0
...
var file_api_novel_activity_v1_activity_proto_rawDesc = []byte{
	...
	0x74, 0x79, 0x12, 0x6a, 0x0a, 0x0f, 0x47, 0x65, 0x74, 0x50, 0x61, 0x67, 0x65, 0x41, 0x63, 0x74,
	0x69, 0x76, 0x69, 0x74, 0x79, 0x12, 0x1c, 0x2e, 0x61, 0x63, 0x74, 0x69, 0x76, 0x69, 0x74, 0x79,
...
var file_api_novel_activity_v1_activity_proto_depIdxs = []int32{
	...
	1,  // 18: activity.v1.Activity.GetPageActivity:input_type -> activity.v1.ActivityPageReq
	...
	2,  // 24: activity.v1.Activity.GetPageActivity:output_type -> activity.v1.ActivityPageReply
