...
func (x *SysJobLogPageReply) GetCode() int64 {
	if x != nil {
		return x.Code
	}
	return 0
...
func (x *SysJobLogReply) GetCode() int64 {
	if x != nil {
		return x.Code
	}
	return 0
...
func (x *SysJobLogCreateReply) GetCode() int64 {
	if x != nil {
		return x.Code
	}
	return 0
...
func (x *SysJobLogUpdateReply) GetCode() int64 {
	if x != nil {
		return x.Code
	}
	return 0
...
func (x *SysJobLogDeleteReply) GetCode() int64 {
	if x != nil {
		return x.Code
	}
	return 0
...
var file_api_admin_sysjoblog_v1_sys_job_log_proto_rawDesc = []byte{
	...
	0x6f, 0x67, 0x12, 0x72, 0x0a, 0x10, 0x47, 0x65, 0x74, 0x50, 0x61, 0x67, 0x65, 0x53, 0x79, 0x73,
	0x4a, 0x6f, 0x62, 0x4c, 0x6f, 0x67, 0x12, 0x1e, 0x2e, 0x73, 0x79, 0x73, 0x6a, 0x6f, 0x62, 0x6c,
...
var file_api_admin_sysjoblog_v1_sys_job_log_proto_depIdxs = []int32{
	...
	1,  // 14: sysjoblog.v1.SysJobLog.GetPageSysJobLog:input_type -> sysjoblog.v1.SysJobLogPageReq
	...
	2,  // 20: sysjoblog.v1.SysJobLog.GetPageSysJobLog:output_type -> sysjoblog.v1.SysJobLogPageReply
